...
class DBpDataset:
    def __init__(self, file_path, device, pair, lang='zh'):
        ...
        if lang == 'zh':
            ...
            self.ent_dict1, self.id_ent1 = self.read_dict('../datasets/dbp_z_e/ent_dict1')
            self.ent_dict2, self.id_ent2 = self.read_dict('../datasets/dbp_z_e/ent_dict2')
        ...
        self.model_link, _ = read_link(file_path + '/GCNAlign_1')
        self.model_pair = self.load_alignment_pair(file_path + '/GCNAlign_1')
